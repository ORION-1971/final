...
import com.javarush.redis.Languagel;
...
public class Main {
    ...
    private List<CityCountry> transformData(List<City> cities) {
        return cities.stream().map(city -> {
            ...
            res.setAlternateCountryCode(country.getCode2());
            ...
            Set<Languagel> languages = countryLanguages.stream().map(cl -> {
                Languagel language = new Languagel();
